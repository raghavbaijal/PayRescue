      ...
      <div className="p-4 sm:p-5 border-b border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-400 mt-0.5">
            Reading directly from PostgreSQL <code className="text-orange-400 bg-slate-950 px-1 py-0.5 rounded text-[11px]">transactions</code> table
          </p>
        </div>
        ...
        <div className="flex items-center space-x-3">
          ...
          <button
            onClick={onRefresh}
            disabled={loading}
            className="p-2 bg-slate-950 border border-slate-800 hover:border-slate-700 text-slate-300 rounded-lg text-xs flex items-center justify-center transition-colors disabled:opacity-50"
